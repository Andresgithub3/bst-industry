  ...
  return (
    <div className="px-6 py-4">
      ...
      <div className="flex flex-col items-center justify-center gap-2 mt-2">
        ...
        <img className="rounded-full h-[150px] w-[150px] object-cover" src="https://images.unsplash.com/photo-1580489944761-15a19d654956?q=80&w=3461&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="avatar" />
